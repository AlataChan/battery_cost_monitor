...
DEFAULT_DECISION_LOG_PATH = SKILL_ROOT / "data/agent_state/procurement_decisions.jsonl"
PROJECT_MARKERS = (
    "gamma_shock_BYTE.py",
    "src/agents/procurement_advisor.py",
    "scripts/run_procurement_advisor.py",
)
...
def main() -> int:
    ...
    decision_log_path = resolve_path(
        args.decision_log_path or os.getenv("PROCUREMENT_DECISION_LOG_PATH"),
